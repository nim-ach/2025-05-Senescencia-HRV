...
m_mod_2 <- brm(
  ...
  seed = 1234,
  file = "models/m_mod_2.RDS"
)

# Visualize models --------------------------------------------------------

## Checking model parameters
bayestestR::describe_posterior(m_mod_2)

# ## Plots of posterior distribution
# plot(m_mod_2)
# 
# ## Posterior predictive checks
# pp_check(m_mod_2, resp = "alpha", ndraws = 100)
# pp_check(m_mod_2, resp = "beta", ndraws = 100)
# pp_check(m_mod_2, resp = "c", ndraws = 100)
# pp_check(m_mod_2, resp = "lambda", ndraws = 100)
# pp_check(m_mod_2, resp = "phi", ndraws = 100)
# pp_check(m_mod_2, resp = "tau", ndraws = 100)
# pp_check(m_mod_2, resp = "delta", ndraws = 100)
...
p_mod_2_long <- melt.data.table(p_mod_2, id.vars = c(".chain", ".iteration", ".draw"))
